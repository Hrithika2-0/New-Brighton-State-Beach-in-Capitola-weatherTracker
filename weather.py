...
# My camping location
LATITUDE = 36.979561
LONGITUDE = -121.939057
LOCATION_NAME = "New Brighton State Beach in Capitola"
...
# Get the temperature right now for this location
...
# Get current weather and append to log
...
full_log_df = pd.read_csv("daily_log.csv", skipinitialspace=True)  # ← just added
full_log_df["datetime"] = pd.to_datetime(full_log_df["time"])      # ← just added
generate_dashboard(full_log_df)                                      # ← just added
